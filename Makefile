...
CTOR = testoracle_ctor_default testoracle_ctor_charArray testoracle_ctor_char   
REL  = testoracle_equal testoracle_lessThan 
COPY = testoracle_ctor_copy testoracle_assign testoracle_swap_assign
OPS  = testoracle_subscript testoracle_len_cap testoracle_input testoracle_find_char testoracle_find_string testoracle_substring testoracle_concat testoracle_split
